-- Script único de reparo (rode se ainda aparecer erro de permissão/workspace)
-- Equivale a 006 + 007 reunidos
...
-- Políticas (qualificadas — evita workspace_id ambiguous)
